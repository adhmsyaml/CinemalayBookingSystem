						 	...
						 	<td>
								...
								<div class="btn-group">
								  ...
								  <div class="dropdown-menu">
								    <a class="dropdown-item edit_movie" href="javascript:void(0)" data-id = '<?php echo $row['movie_id'] ?>'>Edit</a>
								    <div class="dropdown-divider"></div>
								    <a class="dropdown-item delete_movie" href="javascript:void(0)" data-id = '<?php echo $row['movie_id'] ?>'>Delete</a>
								  </div>
								</div>
								</center>
						 	</td>
