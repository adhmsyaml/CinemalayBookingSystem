			...
			<div class="card-body">
				<table class="table table-bordered">
					...
					<tbody>
						<?php
						$i = 1;
						$movie = $conn->query("SELECT b.*,m.title,ts.seat_group,t.name as theater FROM books b inner join movies m on b.movie_id = m.movie_id inner join theater_settings ts on ts.ts_id = b.ts_id inner join theater t on t.theater_id = ts.theater_id  ");
						while($row=$movie->fetch_assoc()){
						 ...
						 <tr>
						 	...
						 	<td>
								...
								<p><small><b>receipt:</b> <?php echo $row['receipt'] ?></small></p>
						 	</td>
