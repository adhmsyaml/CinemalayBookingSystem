						 	...
						 	<td>
								...
								<div class="btn-group">
								  ...
								  <div class="dropdown-menu">
								    <a class="dropdown-item edit_theater" href="javascript:void(0)" data-id = '<?php echo $row['theater_id'] ?>'>Edit</a>
								    <div class="dropdown-divider"></div>
								    <a class="dropdown-item delete_theater" href="javascript:void(0)" data-id = '<?php echo $row['theater_id'] ?>'>Delete</a>
								  </div>
								</div>
								</center>
						 	</td>
			...
			<div class="card-body">
				<table class="table table-bordered">
					...
					<tbody>
						<?php
						$i = 1;
						$theater = $conn->query("SELECT ts.*,t.name FROM theater_settings ts inner join theater t on ts.theater_id = t.theater_id  order by t.name asc,ts.seat_group asc ");
						while($row=$theater->fetch_assoc()){
						 ?>
						 <tr>
						 	<td><?php echo $i++ ?></td>
						 	...
						 	<td>
								...
								<div class="btn-group">
								  ...
								  <div class="dropdown-menu">
								    <a class="dropdown-item edit_seat" href="javascript:void(0)" data-id = '<?php echo $row['ts_id'] ?>'>Edit</a>
								    <div class="dropdown-divider"></div>
								    <a class="dropdown-item delete_seat" href="javascript:void(0)" data-id = '<?php echo $row['ts_id'] ?>'>Delete</a>
								  </div>
								</div>
								</center>
						 	</td>
